...
/**
 * Rewrites generated Sass code to use package-qualified paths for testing.
 * Replaces package imports with `igniteui-theming/sass/...` paths that
 * the themingImporter can resolve.
 *
 * Handles:
 * - Base module: @use 'igniteui-theming' as *; → @use 'igniteui-theming/sass' as *;
 * - Angular module: @use "igniteui-angular/theming" as *; → @use 'igniteui-theming/sass' as *;
 * - Sub-module presets are already in the correct form: @use 'igniteui-theming/sass/...' as *;
 */
