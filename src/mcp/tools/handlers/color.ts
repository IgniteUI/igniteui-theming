 ...
 */
function buildColorReference(color: string, variant: string, contrast: boolean): string {
 ...
 */
function buildDescription(color: string, variant: string, contrast: boolean, opacity?: number): string {
  let desc = contrast
