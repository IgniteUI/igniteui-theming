...
describe('generateWCImports', () => {
  it('generates imports for custom colors', () => {
    ...
    expect(imports.join('\n')).toContain("@use 'igniteui-theming/sass/typography/presets/material' as *;");
    expect(imports.join('\n')).toContain("@use 'igniteui-theming/sass/elevations/presets' as *;");
  });
  ...
  it('generates imports for preset palette', () => {
    ...
    expect(imports.join('\n')).toContain("@use 'igniteui-theming/sass/color/presets/dark/indigo' as *;");
    expect(imports.join('\n')).toContain("@use 'igniteui-theming' as *;");
    expect(imports.join('\n')).toContain("@use 'igniteui-theming/sass/typography/presets/indigo' as *;");
  });
...
describe('generateWCRootVariables', () => {
  ...
  it('generates root variables with map.get for custom palette', () => {
    ...
    expect(output).toContain("--ig-theme: #{map.get($palette, '_meta', 'variant')}");
...
describe('generateWebComponentsThemeSass (integration)', () => {
  it('generates complete theme for preset palette', () => {
    ...
    // Imports
    expect(code).toContain("@use 'igniteui-theming/sass/color/presets/light/material' as *;");
