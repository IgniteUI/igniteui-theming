...
function createShadesBasedPalette(
	overrides?: Partial<CreateCustomPaletteInput>,
): CreateCustomPaletteInput {
...
describe("formatCustomPaletteValidation", () => {
	...
	it("formats warnings", () => {
		const result: CustomPaletteValidationResult = {
			...
			errors: [],
			warnings: [
				{ field: "gray", message: "Consider adjusting", severity: "warning" },
			],
		};
		const formatted = formatCustomPaletteValidation(result);
	...
	it("formats both errors and warnings", () => {
		const result: CustomPaletteValidationResult = {
			...
			warnings: [
				{ field: "gray", message: "Warning message", severity: "warning" },
			],
		};
		const formatted = formatCustomPaletteValidation(result);
