...
export const COMPOUND_COMPONENTS: Record<string, CompoundComponentInfo> = {
  ...
  "file-input": {
    description: 'The file input component uses an input-group for the input field and a button for browsing files.',
    relatedThemes: ['input-group', 'file-input'],
    innerSelectors: {
      angular: {
        'input-group': 'igx-input-group[class~="igx-input-group--file"]',
        'file-input': 'igx-input-group[class~="igx-input-group--file"]',
      },
      webcomponents: {
        'input-group': 'igc-file-input',
        'file-input': 'igc-file-input',
      }
    }
  },
  select: {
  ...
  grid: {
    ...
    innerSelectors: {
      angular: {
        ...
        'flat-icon-button': 'igx-grid .igx-icon-button--flat',
        'outlined-icon-button': 'igx-grid .igx-icon-button--outlined',
        'contained-icon-button': 'igx-grid .igx-icon-button--contained',
        calendar: 'igx-grid igx-calendar',
        snackbar: 'igx-grid igx-snackbar',
        paginator: 'igx-paginator',
        select: 'igx-grid igx-select',
        'grid-summary': '.igx-grid-summary',
        'grid-toolbar': 'igx-grid-toolbar',
      },
      webcomponents: {
        'action-strip': 'igc-action-strip',
        checkbox: 'TODO',
        chip: 'TODO',
        'input-group': 'TODO',
        'drop-down': 'TODO',
        ...
        calendar: 'TODO',
        snackbar: 'TODO',
        paginator: 'igc-paginator',
        select: 'TODO',
        'grid-summary': 'TODO',
        'grid-toolbar': 'igc-grid-toolbar',
      },
    },
  },
  'query-builder': {
