...
export const LAYOUT_OVERVIEW_DOC = `# Layout scale overview
...
export const PAD_FUNCTION_DOC = `# pad() function
...
export const SIZABLE_FUNCTION_DOC = `# sizable() function
...
export const BORDER_RADIUS_FUNCTION_DOC = `# border-radius() function
...
export const SPACING_MIXIN_DOC = `# spacing() mixin
...
export const SIZING_MIXIN_DOC = `# sizing() mixin
...
export const SIZABLE_MIXIN_DOC = `# sizable() mixin
