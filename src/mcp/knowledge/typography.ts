...
import typescalesData from '../../../json/typography/presets/typescales.json' with {type: 'json'};
 ...
 */
export const TYPOGRAPHY_PRESETS = typescalesData as Record<DesignSystem, TypeScale>;
